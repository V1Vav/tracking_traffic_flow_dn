...
class FlowApp:
    def __init__(self):
        ...
        self.available_models = ["models/yolov8n.pt", "models/yolov8s.pt", "models/yolov8m.pt", "models/yolov8l.pt", "models/yolov8x.pt", "models/tuning_50.pt", "models/tuning_200.pt"]
